...
(0, vitest_1.test)("IPv4 validation", () => {
    ...
    (0, vitest_1.expect)(ipv4.safeParse("114.71.82.94").success).toBe(true);
    (0, vitest_1.expect)(ipv4.safeParse("0.0.0.0").success).toBe(true);
    (0, vitest_1.expect)(ipv4.safeParse("37.85.236.115").success).toBe(true);
    (0, vitest_1.expect)(ipv4.safeParse("192.168.0.1").success).toBe(true);
    (0, vitest_1.expect)(ipv4.safeParse("255.255.255.255").success).toBe(true);
    (0, vitest_1.expect)(ipv4.safeParse("1.2.3.4").success).toBe(true);
    ...
    (0, vitest_1.expect)(ipv4.safeParse("a6ea::2454:a5ce:94.105.123.75").success).toBe(false);
    (0, vitest_1.expect)(ipv4.safeParse("not an ip").success).toBe(false);
    (0, vitest_1.expect)(ipv4.safeParse("1.2.3").success).toBe(false);
    (0, vitest_1.expect)(ipv4.safeParse("1.2.3.4.5").success).toBe(false);
...
(0, vitest_1.test)("IPv6 validation", () => {
    ...
    (0, vitest_1.expect)(ipv6.safeParse("a6ea::2454:a5ce:94.105.123.75").success).toBe(true);
    ...
    (0, vitest_1.expect)(ipv6.safeParse("2001:db8::192.168.0.1").success).toBe(true);
    (0, vitest_1.expect)(ipv6.safeParse("::ffff:192.168.0.1").success).toBe(true);
    (0, vitest_1.expect)(ipv6.safeParse("::ffff:c000:0280").success).toBe(true); // IPv4-mapped IPv6 address
    (0, vitest_1.expect)(ipv6.safeParse("64:ff9b::192.168.0.1").success).toBe(true); // IPv4/IPv6 translation
    ...
    (0, vitest_1.expect)(ipv6.safeParse("114.71.82.94").success).toBe(false);
...
(0, vitest_1.test)("CIDR v4 validation", () => {
    ...
    (0, vitest_1.expect)(cidrV4.safeParse("192.168.0.0/24").success).toBe(true);
    (0, vitest_1.expect)(cidrV4.safeParse("10.0.0.0/8").success).toBe(true);
    (0, vitest_1.expect)(cidrV4.safeParse("172.16.0.0/12").success).toBe(true);
    (0, vitest_1.expect)(cidrV4.safeParse("0.0.0.0/0").success).toBe(true);
    (0, vitest_1.expect)(cidrV4.safeParse("255.255.255.255/32").success).toBe(true);
    // Invalid CIDR v4 addresses
    (0, vitest_1.expect)(cidrV4.safeParse("192.168.0.0").success).toBe(false); // Missing prefix
    (0, vitest_1.expect)(cidrV4.safeParse("192.168.0.0/33").success).toBe(false); // Invalid prefix length
    (0, vitest_1.expect)(cidrV4.safeParse("256.0.0.0/24").success).toBe(false); // Invalid IP
    (0, vitest_1.expect)(cidrV4.safeParse("192.168.0.0/-1").success).toBe(false); // Negative prefix length
...
(0, vitest_1.test)("CIDR v6 validation", () => {
    ...
    (0, vitest_1.expect)(cidrV6.safeParse("192.168.0.0/24").success).toBe(false); // IPv4 CIDR in v6 validation
});
