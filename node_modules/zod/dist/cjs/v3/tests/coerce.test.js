...
(0, vitest_1.test)("number coercion", () => {
    ...
    (0, vitest_1.expect)(schema.parse(Number.POSITIVE_INFINITY)).toEqual(Number.POSITIVE_INFINITY);
    (0, vitest_1.expect)(schema.parse(Number.NEGATIVE_INFINITY)).toEqual(Number.NEGATIVE_INFINITY);
