...
for (const str of validBase64Strings) {
    (0, vitest_1.test)(`base64 should accept ${str}`, () => {
        (0, vitest_1.expect)(z.string().base64().safeParse(str).success).toBe(true);
    });
}
...
for (const str of invalidBase64Strings) {
    (0, vitest_1.test)(`base64 should reject ${str}`, () => {
        (0, vitest_1.expect)(z.string().base64().safeParse(str).success).toBe(false);
    });
}
...
for (const str of validBase64URLStrings) {
    (0, vitest_1.test)(`base64url should accept ${str}`, () => {
        (0, vitest_1.expect)(z.string().base64url().safeParse(str).success).toBe(true);
    });
}
...
for (const str of invalidBase64URLStrings) {
    (0, vitest_1.test)(`base64url should reject ${str}`, () => {
        (0, vitest_1.expect)(z.string().base64url().safeParse(str).success).toBe(false);
    });
}
function makeJwt(header, payload) {
    const headerBase64 = node_buffer_1.Buffer.from(JSON.stringify(header)).toString("base64url");
    const payloadBase64 = node_buffer_1.Buffer.from(JSON.stringify(payload)).toString("base64url");
    const signature = "signature"; // Placeholder for the signature
    return `${headerBase64}.${payloadBase64}.${signature}`;
}
(0, vitest_1.test)("jwt validations", () => {
    ...
    (0, vitest_1.expect)(() => jwt.parse(d1)).not.toThrow();
    (0, vitest_1.expect)(() => jwtWithAlg.parse(d1)).not.toThrow();
    // Invalid header
    const d2 = makeJwt({}, {});
    (0, vitest_1.expect)(() => jwt.parse(d2)).toThrow();
    // Wrong algorithm
    const d3 = makeJwt({ typ: "JWT", alg: "RS256" }, {});
    (0, vitest_1.expect)(() => jwtWithAlg.parse(d3)).toThrow();
    // missing typ is fine
    ...
    try {
        ...
        (0, vitest_1.expect)(error.issues[0].message).toBe(customMsg);
    }
});
(0, vitest_1.test)("url validations", () => {
    ...
    (0, vitest_1.expect)(() => url.parse("asdfj@lkjsdf.com")).toThrow();
});
...
(0, vitest_1.test)("ulid", () => {
    ...
    (0, vitest_1.expect)(ulid.safeParse(tooLong).success).toEqual(false);
    if (!result.success) {
...
(0, vitest_1.test)("regexp error message", () => {
    const result = z
        ...
        .safeParse("boooo");
    if (!result.success) {
        (0, vitest_1.expect)(result.error.issues[0].message).toEqual("Invalid");
    }
    else {
...
(0, vitest_1.test)("checks getters", () => {
    (0, vitest_1.expect)(z.string().email().isEmail).toEqual(true);
    (0, vitest_1.expect)(z.string().email().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().email().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isURL).toEqual(true);
    (0, vitest_1.expect)(z.string().url().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().url().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isCUID).toEqual(true);
    (0, vitest_1.expect)(z.string().cuid().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isCUID2).toEqual(true);
    (0, vitest_1.expect)(z.string().cuid2().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().cuid2().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isUUID).toEqual(true);
    (0, vitest_1.expect)(z.string().uuid().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().uuid().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isNANOID).toEqual(true);
    (0, vitest_1.expect)(z.string().nanoid().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().nanoid().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isIP).toEqual(true);
    (0, vitest_1.expect)(z.string().ip().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().ip().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().cidr().isCIDR).toEqual(true);
    (0, vitest_1.expect)(z.string().cidr().isULID).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isEmail).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isURL).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isCUID).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isCUID2).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isUUID).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isNANOID).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isIP).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isCIDR).toEqual(false);
    (0, vitest_1.expect)(z.string().ulid().isULID).toEqual(true);
});
...
(0, vitest_1.test)("datetime", () => {
    ...
    (0, vitest_1.expect)(a.isDatetime).toEqual(true);
    const b = z.string().datetime({ offset: true });
    (0, vitest_1.expect)(b.isDatetime).toEqual(true);
    const c = z.string().datetime({ precision: 3 });
    (0, vitest_1.expect)(c.isDatetime).toEqual(true);
    const d = z.string().datetime({ offset: true, precision: 0 });
    (0, vitest_1.expect)(d.isDatetime).toEqual(true);
    const { isDatetime } = z.string().datetime();
    (0, vitest_1.expect)(isDatetime).toEqual(true);
});
(0, vitest_1.test)("datetime parsing", () => {
    ...
    (0, vitest_1.expect)(() => datetime.parse("2020-10-14T17:42.123+00:00")).toThrow();
    ...
    (0, vitest_1.expect)(() => datetime3Ms.parse("2022-10-13T09:52Z")).toThrow();
    ...
    (0, vitest_1.expect)(() => datetimeOffset4Ms.parse("2020-10-14T17:42+00:00")).toThrow();
});
(0, vitest_1.test)("date", () => {
    const a = z.string().date();
    (0, vitest_1.expect)(a.isDate).toEqual(true);
});
...
(0, vitest_1.test)("time", () => {
    const a = z.string().time();
    (0, vitest_1.expect)(a.isTime).toEqual(true);
});
(0, vitest_1.test)("time parsing", () => {
    ...
    (0, vitest_1.expect)(() => time.parse("24:60")).toThrow();
    ...
    (0, vitest_1.expect)(() => time2.parse("23:59")).toThrow();
...
(0, vitest_1.test)("duration", () => {
    ...
    (0, vitest_1.expect)(duration.isDuration).toEqual(true);
    ...
    for (const val of invalidDurations) {
        ...
        (0, vitest_1.expect)(result.error.issues[0].message).toEqual("Invalid duration");
    }
});
(0, vitest_1.test)("IP validation", () => {
    const ip = z.string().ip();
    (0, vitest_1.expect)(ip.safeParse("122.122.122.122").success).toBe(true);
    const ipv4 = z.string().ip({ version: "v4" });
    (0, vitest_1.expect)(() => ipv4.parse("6097:adfa:6f0b:220d:db08:5021:6191:7990")).toThrow();
    const ipv6 = z.string().ip({ version: "v6" });
    (0, vitest_1.expect)(() => ipv6.parse("254.164.77.1")).toThrow();
    const validIPs = [
    ...
    (0, vitest_1.expect)(validIPs.every((ip) => ipSchema.safeParse(ip).success)).toBe(true);
    (0, vitest_1.expect)(invalidIPs.every((ip) => ipSchema.safeParse(ip).success === false)).toBe(true);
});
(0, vitest_1.test)("CIDR validation", () => {
    const ipv4Cidr = z.string().cidr({ version: "v4" });
    (0, vitest_1.expect)(() => ipv4Cidr.parse("2001:0db8:85a3::8a2e:0370:7334/64")).toThrow();
    const ipv6Cidr = z.string().cidr({ version: "v6" });
    (0, vitest_1.expect)(() => ipv6Cidr.parse("192.168.0.1/24")).toThrow();
    const validCidrs = [
        "192.168.0.0/24",
        "10.0.0.0/8",
        "203.0.113.0/24",
    ...
    (0, vitest_1.expect)(validCidrs.every((ip) => cidrSchema.safeParse(ip).success)).toBe(true);
    (0, vitest_1.expect)(invalidCidrs.every((ip) => cidrSchema.safeParse(ip).success === false)).toBe(true);
});
